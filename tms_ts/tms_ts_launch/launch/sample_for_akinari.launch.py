...
def generate_launch_description():
      ...
      return LaunchDescription([
            ...
            DeclareLaunchArgument('task_id1', default_value="31"), # The task to control ic120 prepared for demo(2024/12) 
            DeclareLaunchArgument('task_id2', default_value="32"), # The task to control zx200 prepared for demo(2024/12) 
