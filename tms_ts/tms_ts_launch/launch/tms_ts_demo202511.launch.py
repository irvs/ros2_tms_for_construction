...
def launch_setup(context, *args, **kwargs):
    ...
    nodes.extend([
        ...
        Node(
              package='tms_ts_primitive', 
              executable='primitive_excavator_level',
              output='screen',
              namespace = 'zx200'),
        Node(
              package='tms_ts_primitive', 
              executable='primitive_excavator_gather',
              output='screen',
              namespace = 'zx200'),
        Node(
              package='tms_ts_primitive', 
      ...
      #   Node(
      #         package='tms_ts_primitive',
      #         executable='primitive_crawlerdump_follow_waypoints_deg_server',
      #         output='screen',
      #         namespace='ic120_1'),
      #   Node(
      #         package='tms_ts_primitive',
      #         executable='primitive_crawlerdump_follow_waypoints_server',
      #         output='screen',
      #         namespace='ic120_1'),
      #   Node(
      #         package='tms_ts_primitive',
      #         executable='primitive_crawlerdump_navigate_anywhere_deg_server',
      #         output='screen',
      #         namespace='ic120_1'),
      #   Node(
      #         package='tms_ts_primitive',
      #         executable='primitive_crawlerdump_navigate_anywhere_server',
      #         output='screen',
      #         namespace='ic120_1'),

      #   Node(
      #         package='tms_ts_primitive',
      #         executable='primitive_crawlerdump_navigate_through_poses_deg_server',
      #         output='screen',
      #         namespace='ic120_1'),
      #   Node(
      #         package='tms_ts_primitive',
      #         executable='primitive_crawlerdump_navigate_through_poses_server',
      #         output='screen',
      #         namespace='ic120_1'),
      #   Node(
      #         package='tms_ts_primitive',
      #         executable='primitive_crawlerdump_release_soil_server',
      #         output='screen',
      #         namespace='ic120_1'),
