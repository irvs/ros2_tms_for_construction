...
#include <vector>
#include "tms_ts_subtask/Excavator/subtask_excavator_navigate_through_poses_deg.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskExcavatorNavigateThroughPosesDeg::SubtaskExcavatorNavigateThroughPosesDeg() : SubtaskNodeBase("st_excavator_navigate_through_poses_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_excavator_navigate_through_poses_deg",
        std::bind(&SubtaskExcavatorNavigateThroughPosesDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskExcavatorNavigateThroughPosesDeg::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskExcavatorNavigateThroughPosesDeg::handle_accepted, this, std::placeholders::_1));

    
    action_client_ = rclcpp_action::create_client<NavigateThroughPoses>(this, "navigate_through_poses");
}

rclcpp_action::GoalResponse SubtaskExcavatorNavigateThroughPosesDeg::handle_goal(
...
rclcpp_action::CancelResponse SubtaskExcavatorNavigateThroughPosesDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskExcavatorNavigateThroughPosesDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskExcavatorNavigateThroughPosesDeg::execute, this, _1), goal_handle }.detach();
}

void SubtaskExcavatorNavigateThroughPosesDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
    RCLCPP_INFO(this->get_logger(), "subtask(st_excavator_navigate_through_poses) is executing...");
...
void SubtaskExcavatorNavigateThroughPosesDeg::goal_response_callback(const GoalHandleExcavatorNavigateThroughPosesDeg::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskExcavatorNavigateThroughPosesDeg::feedback_callback(
...
//result
void SubtaskExcavatorNavigateThroughPosesDeg::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskExcavatorNavigateThroughPosesDeg>());
    rclcpp::shutdown();
    return 0;
}
