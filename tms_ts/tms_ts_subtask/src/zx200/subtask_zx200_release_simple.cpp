...
SubtaskZx200ReleaseSimple::SubtaskZx200ReleaseSimple() : SubtaskNodeBase("subtask_zx200_release_simple_node")
{
  ...
  this->action_client_ = rclcpp_action::create_client<Zx200ReleaseSimple>(this, "tms_rp_zx200_release_simple");
...
std::map<std::string, double> SubtaskZx200ReleaseSimple::GetParamFromDB(std::string model_name, std::string record_name)
{
  // Connect to MongoDB
