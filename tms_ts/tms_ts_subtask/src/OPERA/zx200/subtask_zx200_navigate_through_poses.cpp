...
#include <vector>
#include "tms_ts_subtask/OPERA/zx200/subtask_zx200_navigate_through_poses.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskZx200NavigateThroughPoses::SubtaskZx200NavigateThroughPoses() : SubtaskNodeBase("st_zx200_navigate_through_poses_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_zx200_navigate_through_poses",
        std::bind(&SubtaskZx200NavigateThroughPoses::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskZx200NavigateThroughPoses::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskZx200NavigateThroughPoses::handle_accepted, this, std::placeholders::_1));

    
    action_client_ = rclcpp_action::create_client<NavigateThroughPoses>(this, "navigate_through_poses");
}

rclcpp_action::GoalResponse SubtaskZx200NavigateThroughPoses::handle_goal(
...
rclcpp_action::CancelResponse SubtaskZx200NavigateThroughPoses::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskZx200NavigateThroughPoses::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskZx200NavigateThroughPoses::execute, this, _1), goal_handle }.detach();
}

void SubtaskZx200NavigateThroughPoses::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
    RCLCPP_INFO(this->get_logger(), "subtask(st_zx200_navigate_through_poses) is executing...");
...
void SubtaskZx200NavigateThroughPoses::goal_response_callback(const GoalHandleZx200NavigateThroughPoses::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskZx200NavigateThroughPoses::feedback_callback(
...
//result
void SubtaskZx200NavigateThroughPoses::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskZx200NavigateThroughPoses>());
    rclcpp::shutdown();
    return 0;
}
