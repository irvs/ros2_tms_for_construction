...
#include "tms_ts_subtask/OPERA/zx200/subtask_zx200_navigate_anywhere.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskZx200NavigateAnywhere::SubtaskZx200NavigateAnywhere() : SubtaskNodeBase("st_zx200_navigate_anywhere_node")
{
    ...
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_zx200_navigate_anywhere",
        std::bind(&SubtaskZx200NavigateAnywhere::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskZx200NavigateAnywhere::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskZx200NavigateAnywhere::handle_accepted, this, std::placeholders::_1),
        options_server); 
...
rclcpp_action::GoalResponse SubtaskZx200NavigateAnywhere::handle_goal(
...
rclcpp_action::CancelResponse SubtaskZx200NavigateAnywhere::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskZx200NavigateAnywhere::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskZx200NavigateAnywhere::execute, this, _1), goal_handle }.detach();
}

void SubtaskZx200NavigateAnywhere::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskZx200NavigateAnywhere::goal_response_callback(const GoalHandleZx200NavigateAnywhere::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskZx200NavigateAnywhere::feedback_callback(
...
//result
void SubtaskZx200NavigateAnywhere::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskZx200NavigateAnywhere>());
    rclcpp::shutdown();
    return 0;
}
