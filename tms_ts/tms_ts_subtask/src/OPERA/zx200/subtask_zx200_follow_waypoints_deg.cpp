...
#include "tms_ts_subtask/OPERA/zx200/subtask_zx200_follow_waypoints_deg.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskZx200FollowWaypointsDeg::SubtaskZx200FollowWaypointsDeg() : SubtaskNodeBase("st_zx200_follow_waypoints_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_zx200_follow_waypoints_deg",
        std::bind(&SubtaskZx200FollowWaypointsDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskZx200FollowWaypointsDeg::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskZx200FollowWaypointsDeg::handle_accepted, this, std::placeholders::_1));

    action_client_ = rclcpp_action::create_client<FollowWaypoints>(this, "follow_waypoints");
}

rclcpp_action::GoalResponse SubtaskZx200FollowWaypointsDeg::handle_goal(
...
rclcpp_action::CancelResponse SubtaskZx200FollowWaypointsDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskZx200FollowWaypointsDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskZx200FollowWaypointsDeg::execute, this, _1), goal_handle }.detach();
}

void SubtaskZx200FollowWaypointsDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
    RCLCPP_INFO(this->get_logger(), "subtask(st_zx200_follow_waypoints_node) is executing...");
...
void SubtaskZx200FollowWaypointsDeg::goal_response_callback(const GoalHandleFollowWaypoints::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskZx200FollowWaypointsDeg::feedback_callback(
...
void SubtaskZx200FollowWaypointsDeg::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskZx200FollowWaypointsDeg>());
    rclcpp::shutdown();
    return 0;
}
