...
#include <vector>
#include "tms_ts_subtask/OPERA/zx200/subtask_zx200_navigate_through_poses_deg.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskZx200NavigateThroughPosesDeg::SubtaskZx200NavigateThroughPosesDeg() : SubtaskNodeBase("st_zx200_navigate_through_poses_deg_node")
{
...
void SubtaskZx200NavigateThroughPosesDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskZx200NavigateThroughPosesDeg::execute, this, _1), goal_handle }.detach();
}

void SubtaskZx200NavigateThroughPosesDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskZx200NavigateThroughPosesDeg>());
    rclcpp::shutdown();
    return 0;
}
