...
#include "tms_ts_subtask/OPERA/ic120/subtask_ic120_follow_waypoints.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskIc120FollowWaypointys::SubtaskIc120FollowWaypointys() : SubtaskNodeBase("st_ic120_follow_waypoints_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_ic120_follow_waypoints",
        std::bind(&SubtaskIc120FollowWaypointys::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
...
rclcpp_action::CancelResponse SubtaskIc120FollowWaypointys::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskIc120FollowWaypointys::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    ...
    std::thread{ std::bind(&SubtaskIc120FollowWaypointys::execute, this, _1), goal_handle }.detach();
}

void SubtaskIc120FollowWaypointys::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskIc120FollowWaypointys::goal_response_callback(const GoalHandleFollowWaypoints::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskIc120FollowWaypointys::feedback_callback(
...
void SubtaskIc120FollowWaypointys::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskIc120FollowWaypointys>());
    rclcpp::shutdown();
    return 0;
}
