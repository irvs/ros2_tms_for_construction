...
#include <vector>
#include "tms_ts_subtask/OPERA/ic120/subtask_ic120_navigate_through_poses_deg.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskIc120NavigateThroughPosesDeg::SubtaskIc120NavigateThroughPosesDeg() : SubtaskNodeBase("st_ic120_navigate_through_poses_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_ic120_navigate_through_poses_deg",
        std::bind(&SubtaskIc120NavigateThroughPosesDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskIc120NavigateThroughPosesDeg::handle_cancel, this, std::placeholders::_1),
...
rclcpp_action::CancelResponse SubtaskIc120NavigateThroughPosesDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskIc120NavigateThroughPosesDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskIc120NavigateThroughPosesDeg::execute, this, _1), goal_handle }.detach();
}

void SubtaskIc120NavigateThroughPosesDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
    RCLCPP_INFO(this->get_logger(), "subtask(st_ic120_navigate_through_poses) is executing...");
...
void SubtaskIc120NavigateThroughPosesDeg::goal_response_callback(const GoalHandleIc120NavigateThroughPoses::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskIc120NavigateThroughPosesDeg::feedback_callback(
    const GoalHandleIc120NavigateThroughPoses::SharedPtr,
    const std::shared_ptr<const GoalHandleIc120NavigateThroughPoses::Feedback> feedback)
{
...
//result
void SubtaskIc120NavigateThroughPosesDeg::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskIc120NavigateThroughPosesDeg>());
    rclcpp::shutdown();
    return 0;
}
