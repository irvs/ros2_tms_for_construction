...
#include "tms_ts_subtask/OPERA/d37pxi/subtask_d37pxi_navigate_anywhere.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskD37pxiNavigateAnywhere::SubtaskD37pxiNavigateAnywhere() : SubtaskNodeBase("st_d37pxi_navigate_anywhere_node")
{
    ...
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_d37pxi_navigate_anywhere",
        std::bind(&SubtaskD37pxiNavigateAnywhere::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskD37pxiNavigateAnywhere::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskD37pxiNavigateAnywhere::handle_accepted, this, std::placeholders::_1),
        options_server); 
...
rclcpp_action::GoalResponse SubtaskD37pxiNavigateAnywhere::handle_goal(
...
rclcpp_action::CancelResponse SubtaskD37pxiNavigateAnywhere::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskD37pxiNavigateAnywhere::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskD37pxiNavigateAnywhere::execute, this, _1), goal_handle }.detach();
}

void SubtaskD37pxiNavigateAnywhere::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskD37pxiNavigateAnywhere::goal_response_callback(const GoalHandleD37pxiNavigateAnywhere::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskD37pxiNavigateAnywhere::feedback_callback(
...
//result
void SubtaskD37pxiNavigateAnywhere::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskD37pxiNavigateAnywhere>());
    rclcpp::shutdown();
    return 0;
}
