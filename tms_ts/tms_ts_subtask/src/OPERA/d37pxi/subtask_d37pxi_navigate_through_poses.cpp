...
#include <vector>
#include "tms_ts_subtask/OPERA/d37pxi/subtask_d37pxi_navigate_through_poses.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskD37pxiNavigateThroughPoses::SubtaskD37pxiNavigateThroughPoses() : SubtaskNodeBase("st_d37pxi_navigate_through_poses_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_d37pxi_navigate_through_poses",
        std::bind(&SubtaskD37pxiNavigateThroughPoses::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskD37pxiNavigateThroughPoses::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskD37pxiNavigateThroughPoses::handle_accepted, this, std::placeholders::_1));

    
    action_client_ = rclcpp_action::create_client<NavigateThroughPoses>(this, "navigate_through_poses");
}

rclcpp_action::GoalResponse SubtaskD37pxiNavigateThroughPoses::handle_goal(
...
rclcpp_action::CancelResponse SubtaskD37pxiNavigateThroughPoses::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskD37pxiNavigateThroughPoses::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskD37pxiNavigateThroughPoses::execute, this, _1), goal_handle }.detach();
}

void SubtaskD37pxiNavigateThroughPoses::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskD37pxiNavigateThroughPoses::goal_response_callback(const GoalHandleD37pxiNavigateThroughPoses::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskD37pxiNavigateThroughPoses::feedback_callback(
...
//result
void SubtaskD37pxiNavigateThroughPoses::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskD37pxiNavigateThroughPoses>());
    rclcpp::shutdown();
    return 0;
}
