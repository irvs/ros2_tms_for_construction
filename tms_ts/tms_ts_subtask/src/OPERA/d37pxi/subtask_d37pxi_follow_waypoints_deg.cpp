...
#include "tms_ts_subtask/OPERA/d37pxi/subtask_d37pxi_follow_waypoints_deg.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskD37pxiFollowWaypointsDeg::SubtaskD37pxiFollowWaypointsDeg() : SubtaskNodeBase("st_d37pxi_follow_waypoints_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_d37pxi_follow_waypoints_deg",
        std::bind(&SubtaskD37pxiFollowWaypointsDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskD37pxiFollowWaypointsDeg::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskD37pxiFollowWaypointsDeg::handle_accepted, this, std::placeholders::_1));

    action_client_ = rclcpp_action::create_client<FollowWaypoints>(this, "follow_waypoints");
}

rclcpp_action::GoalResponse SubtaskD37pxiFollowWaypointsDeg::handle_goal(
...
rclcpp_action::CancelResponse SubtaskD37pxiFollowWaypointsDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskD37pxiFollowWaypointsDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskD37pxiFollowWaypointsDeg::execute, this, _1), goal_handle }.detach();
}

void SubtaskD37pxiFollowWaypointsDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
    RCLCPP_INFO(this->get_logger(), "subtask(st_d37pxi_follow_waypoints_node) is executing...");
...
void SubtaskD37pxiFollowWaypointsDeg::goal_response_callback(const GoalHandleFollowWaypoints::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskD37pxiFollowWaypointsDeg::feedback_callback(
...
void SubtaskD37pxiFollowWaypointsDeg::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskD37pxiFollowWaypointsDeg>());
    rclcpp::shutdown();
    return 0;
}
