...
#include "tms_ts_subtask/OPERA/d37pxi/subtask_d37pxi_navigate_anywhere_deg.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskD37pxiNavigateAnywhereDeg::SubtaskD37pxiNavigateAnywhereDeg() : SubtaskNodeBase("st_d37pxi_navigate_anywhere_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_d37pxi_navigate_anywhere_deg",
        std::bind(&SubtaskD37pxiNavigateAnywhereDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskD37pxiNavigateAnywhereDeg::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskD37pxiNavigateAnywhereDeg::handle_accepted, this, std::placeholders::_1));
...
rclcpp_action::GoalResponse SubtaskD37pxiNavigateAnywhereDeg::handle_goal(
...
rclcpp_action::CancelResponse SubtaskD37pxiNavigateAnywhereDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskD37pxiNavigateAnywhereDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskD37pxiNavigateAnywhereDeg::execute, this, _1), goal_handle }.detach();
}

void SubtaskD37pxiNavigateAnywhereDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
    RCLCPP_INFO(this->get_logger(), "subtask(st_d37pxi_navigate_anywhere_node) is executing...");
...
void SubtaskD37pxiNavigateAnywhereDeg::goal_response_callback(const GoalHandleD37pxiNavigateAnywhere::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskD37pxiNavigateAnywhereDeg::feedback_callback(
    const GoalHandleD37pxiNavigateAnywhere::SharedPtr,
    const std::shared_ptr<const GoalHandleD37pxiNavigateAnywhere::Feedback> feedback)
{
...
//result
void SubtaskD37pxiNavigateAnywhereDeg::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
                                             const GoalHandleD37pxiNavigateAnywhere::WrappedResult& result)
{
  if (!goal_handle->is_active())
  {
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskD37pxiNavigateAnywhereDeg>());
    rclcpp::shutdown();
    return 0;
}
