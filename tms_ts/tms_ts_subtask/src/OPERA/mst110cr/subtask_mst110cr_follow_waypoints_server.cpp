...
#include "tms_ts_subtask/OPERA/mst110cr/subtask_mst110cr_follow_waypoints.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskMst110crFollowWaypointys::SubtaskMst110crFollowWaypointys() : SubtaskNodeBase("st_mst110cr_follow_waypoints_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_mst110cr_follow_waypoints",
        std::bind(&SubtaskMst110crFollowWaypointys::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskMst110crFollowWaypointys::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskMst110crFollowWaypointys::handle_accepted, this, std::placeholders::_1));

    action_client_ = rclcpp_action::create_client<FollowWaypoints>(this, "follow_waypoints");
}

rclcpp_action::GoalResponse SubtaskMst110crFollowWaypointys::handle_goal(
...
rclcpp_action::CancelResponse SubtaskMst110crFollowWaypointys::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskMst110crFollowWaypointys::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskMst110crFollowWaypointys::execute, this, _1), goal_handle }.detach();
}

void SubtaskMst110crFollowWaypointys::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskMst110crFollowWaypointys::goal_response_callback(const GoalHandleFollowWaypoints::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskMst110crFollowWaypointys::feedback_callback(
...
void SubtaskMst110crFollowWaypointys::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskMst110crFollowWaypointys>());
    rclcpp::shutdown();
    return 0;
}
