...
#include "tms_ts_subtask/OPERA/mst110cr/subtask_mst110cr_navigate_anywhere.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskMst110crNavigateAnywhere::SubtaskMst110crNavigateAnywhere() : SubtaskNodeBase("st_mst110cr_navigate_anywhere_node")
{
    ...
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_mst110cr_navigate_anywhere",
        std::bind(&SubtaskMst110crNavigateAnywhere::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskMst110crNavigateAnywhere::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskMst110crNavigateAnywhere::handle_accepted, this, std::placeholders::_1),
        options_server); 
...
rclcpp_action::GoalResponse SubtaskMst110crNavigateAnywhere::handle_goal(
...
rclcpp_action::CancelResponse SubtaskMst110crNavigateAnywhere::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskMst110crNavigateAnywhere::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskMst110crNavigateAnywhere::execute, this, _1), goal_handle }.detach();
}

void SubtaskMst110crNavigateAnywhere::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
    RCLCPP_INFO(this->get_logger(), "subtask(st_mst110cr_navigate_anywhere_node) is executing...");
...
void SubtaskMst110crNavigateAnywhere::goal_response_callback(const GoalHandleMst110crNavigateAnywhere::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskMst110crNavigateAnywhere::feedback_callback(
...
//result
void SubtaskMst110crNavigateAnywhere::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskMst110crNavigateAnywhere>());
    rclcpp::shutdown();
    return 0;
}
