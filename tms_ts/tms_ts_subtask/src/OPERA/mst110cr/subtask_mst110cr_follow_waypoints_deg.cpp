...
#include "tms_ts_subtask/OPERA/mst110cr/subtask_mst110cr_follow_waypoints_deg.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskMst110crFollowWaypointsDeg::SubtaskMst110crFollowWaypointsDeg() : SubtaskNodeBase("st_mst110cr_follow_waypoints_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_mst110cr_follow_waypoints_deg",
        std::bind(&SubtaskMst110crFollowWaypointsDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskMst110crFollowWaypointsDeg::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskMst110crFollowWaypointsDeg::handle_accepted, this, std::placeholders::_1));

    action_client_ = rclcpp_action::create_client<FollowWaypoints>(this, "follow_waypoints");
}

rclcpp_action::GoalResponse SubtaskMst110crFollowWaypointsDeg::handle_goal(
...
rclcpp_action::CancelResponse SubtaskMst110crFollowWaypointsDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskMst110crFollowWaypointsDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskMst110crFollowWaypointsDeg::execute, this, _1), goal_handle }.detach();
}

void SubtaskMst110crFollowWaypointsDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
    RCLCPP_INFO(this->get_logger(), "subtask(st_mst110cr_follow_waypoints_node) is executing...");
...
void SubtaskMst110crFollowWaypointsDeg::goal_response_callback(const GoalHandleFollowWaypoints::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskMst110crFollowWaypointsDeg::feedback_callback(
...
void SubtaskMst110crFollowWaypointsDeg::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskMst110crFollowWaypointsDeg>());
    rclcpp::shutdown();
    return 0;
}
