...
#include "tms_ts_subtask/OPERA/mst110cr/subtask_mst110cr_navigate_anywhere_deg.hpp"
...
SubtaskMst110crNavigateAnywhereDeg::SubtaskMst110crNavigateAnywhereDeg() : SubtaskNodeBase("st_mst110cr_navigate_anywhere_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        ...
        std::bind(&SubtaskMst110crNavigateAnywhereDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskMst110crNavigateAnywhereDeg::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskMst110crNavigateAnywhereDeg::handle_accepted, this, std::placeholders::_1));
...
rclcpp_action::GoalResponse SubtaskMst110crNavigateAnywhereDeg::handle_goal(
...
rclcpp_action::CancelResponse SubtaskMst110crNavigateAnywhereDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskMst110crNavigateAnywhereDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskMst110crNavigateAnywhereDeg::execute, this, _1), goal_handle }.detach();
}

void SubtaskMst110crNavigateAnywhereDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskMst110crNavigateAnywhereDeg>());
    rclcpp::shutdown();
    return 0;
}
