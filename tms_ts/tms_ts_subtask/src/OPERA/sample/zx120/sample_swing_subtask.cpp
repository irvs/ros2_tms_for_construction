...
#include "tms_ts_subtask/OPERA/sample/zx120/sample_swing_subtask.hpp"
#include <glog/logging.h>

using namespace std::chrono_literals;

SubtaskSampleZx120Swing::SubtaskSampleZx120Swing() : SubtaskNodeBase("st_zx120_sample_swing_node")
{
  publisher_ = this->create_publisher<std_msgs::msg::Float64>("/zx120/swing/cmd", 10);
  this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
      this, "st_zx120_sample_swing",
...
rclcpp_action::GoalResponse SubtaskSampleZx120Swing::handle_goal(
