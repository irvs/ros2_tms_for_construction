...
#include "tms_ts_subtask/crane/zx200/sample_swing_subtask.hpp"
#include <glog/logging.h>

using namespace std::chrono_literals;

SubtaskSampleZx200Swing::SubtaskSampleZx200Swing() : SubtaskNodeBase("subtask_sample_zx200_swing")
{
...
rclcpp_action::GoalResponse SubtaskSampleZx200Swing::handle_goal(const rclcpp_action::GoalUUID &uuid, std::shared_ptr<const tms_msg_ts::action::LeafNodeBase::Goal> goal)
{
    ...
    RCLCPP_INFO(this->get_logger(), "param = %d", parameters["zx200_swing_goal_pos"]);
