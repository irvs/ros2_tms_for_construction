...
#ifndef TMS_TS_SUBTASK_EXCAVATOR_FOLLOW_WAYPOINTS_DEG_HPP
#define TMS_TS_SUBTASK_EXCAVATOR_FOLLOW_WAYPOINTS_DEG_HPP
...
class SubtaskExcavatorFollowWaypointsDeg : public SubtaskNodeBase
{
public:
    ...
    SubtaskExcavatorFollowWaypointsDeg();
