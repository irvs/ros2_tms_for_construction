...
#ifndef SAMPLE_SUBTASK_ZX200_NAVIGATE_THROUGH_POSES_HPP
#define SAMPLE_SUBTASK_ZX200_NAVIGATE_THROUGH_POSES_HPP
...
class SubtaskZx200NavigateThroughPoses : public SubtaskNodeBase
{
public:
    ...
    SubtaskZx200NavigateThroughPoses();
