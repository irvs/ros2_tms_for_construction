...
#ifndef SAMPLE_SUBTASK_BULLDOZER_NAVIGATE_THROUGH_POSES_HPP
#define SAMPLE_SUBTASK_BULLDOZER_NAVIGATE_THROUGH_POSES_HPP
...
class SubtaskBulldozerNavigateThroughPoses : public SubtaskNodeBase
{
public:
    ...
    SubtaskBulldozerNavigateThroughPoses();
