...
#ifndef LEAF_NODE_D37PXI_HPP_
#define LEAF_NODE_D37PXI_HPP_
...
class LeafNodeD37pxi : public LeafNodeBase
{
public:
  inline LeafNodeD37pxi(const std::string& name, const NodeConfiguration& config)
