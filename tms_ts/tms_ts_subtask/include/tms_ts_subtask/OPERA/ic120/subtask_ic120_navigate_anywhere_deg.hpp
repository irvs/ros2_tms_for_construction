...
#ifndef SAMPLE_SUBTASK_IC120_NAVIGATE_ANYWHERE_DEG_HPP
#define SAMPLE_SUBTASK_IC120_NAVIGATE_ANYWHERE_DEG_HPP
...
class SubtaskIc120NavigateAnywhereDeg : public SubtaskNodeBase
{
public:
    ...
    SubtaskIc120NavigateAnywhereDeg();
