...
#ifndef TMS_TS_SUBTASK_MST110CR_FOLLOW_WAYPOINTS_HPP
#define TMS_TS_SUBTASK_MST110CR_FOLLOW_WAYPOINTS_HPP
...
class SubtaskMst110crFollowWaypointys : public SubtaskNodeBase
{
public:
    ...
    SubtaskMst110crFollowWaypointys();
