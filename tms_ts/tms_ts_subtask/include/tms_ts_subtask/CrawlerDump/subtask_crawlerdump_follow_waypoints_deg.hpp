...
#ifndef TMS_TS_SUBTASK_CRAWLERDUMP_FOLLOW_WAYPOINTS_DEG_HPP
#define TMS_TS_SUBTASK_CRAWLERDUMP_FOLLOW_WAYPOINTS_DEG_HPP
...
class SubtaskCrawlerDumpFollowWaypointsDeg : public SubtaskNodeBase
{
public:
    ...
    SubtaskCrawlerDumpFollowWaypointsDeg();
