...
#ifndef TMS_TS_SUBTASK_CRAWLERDUMP_FOLLOW_PATH_HPP
#define TMS_TS_SUBTASK_CRAWLERDUMP_FOLLOW_PATH_HPP
...
class SubtaskCrawlerDumpFollowPath : public SubtaskNodeBase
{
public:
...
#endif  // TMS_TS_SUBTASK_CRAWLERDUMP_FOLLOW_WAYPOINTS_HPP
