...
#ifndef SAMPLE_SUBTASK_CRAWLERDUMP_RELEASE_SOIL_HPP
#define SAMPLE_SUBTASK_CRAWLERDUMP_RELEASE_SOIL_HPP
...
class SubtaskCrawlerDumpReleaseSoil : public SubtaskNodeBase
{
public:
