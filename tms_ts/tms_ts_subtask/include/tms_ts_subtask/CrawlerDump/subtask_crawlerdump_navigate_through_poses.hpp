...
#ifndef SAMPLE_SUBTASK_CRAWLERDUMP_NAVIGATE_THROUGH_POSES_HPP
#define SAMPLE_SUBTASK_CRAWLERDUMP_NAVIGATE_THROUGH_POSES_HPP
...
class SubtaskCrawlerDumpNavigateThroughPoses : public SubtaskNodeBase
{
public:
    ...
    SubtaskCrawlerDumpNavigateThroughPoses();
