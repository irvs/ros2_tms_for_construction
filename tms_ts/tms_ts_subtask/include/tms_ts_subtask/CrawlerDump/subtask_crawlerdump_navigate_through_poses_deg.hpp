...
#ifndef SAMPLE_SUBTASK_CRAWLERDUMP_NAVIGATE_THROUGH_POSES_DEG_HPP
#define SAMPLE_SUBTASK_CRAWLERDUMP_NAVIGATE_THROUGH_POSES_DEG_HPP
...
class SubtaskCrawlerDumpNavigateThroughPosesDeg : public SubtaskNodeBase
{
public:
    ...
    SubtaskCrawlerDumpNavigateThroughPosesDeg();
