...
#ifndef SAMPLE_SUBTASK_MST110CR_NAVIGATE_ANYWHERE_HPP
#define SAMPLE_SUBTASK_MST110CR_NAVIGATE_ANYWHERE_HPP
...
class SubtaskMst110crNavigateAnywhere : public SubtaskNodeBase
{
public:
    ...
    SubtaskMst110crNavigateAnywhere();
