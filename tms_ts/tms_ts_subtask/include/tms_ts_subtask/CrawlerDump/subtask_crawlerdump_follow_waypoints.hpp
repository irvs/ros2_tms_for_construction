...
#ifndef TMS_TS_SUBTASK_CRAWLERDUMP_FOLLOW_WAYPOINTS_HPP
#define TMS_TS_SUBTASK_CRAWLERDUMP_FOLLOW_WAYPOINTS_HPP
...
class SubtaskCrawlerDumpFollowWaypointys : public SubtaskNodeBase
{
public:
    ...
    SubtaskCrawlerDumpFollowWaypointys();
