...
#ifndef SAMPLE_SUBTASK_CRAWLERDUMP_NAVIGATE_ANYWHERE_HPP
#define SAMPLE_SUBTASK__NAVIGATE_ANYWHERE_HPP
...
class SubtaskCrawlerDumpNavigateAnywhere : public SubtaskNodeBase
{
public:
    ...
    SubtaskCrawlerDumpNavigateAnywhere();
