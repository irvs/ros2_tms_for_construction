...
#ifndef SAMPLE_SUBTASK_MST110CR_RELEASE_SOIL_HPP
#define SAMPLE_SUBTASK_MST110CR_RELEASE_SOIL_HPP
...
class SubtaskMst110crReleaseSoil : public SubtaskNodeBase
{
public:
    ...
    using GoalHandleMst110crReleaseSoil = rclcpp_action::ClientGoalHandle<SetDumpAngle>;
    SubtaskMst110crReleaseSoil();
...
private:
    ...
    std::shared_future<GoalHandleMst110crReleaseSoil::SharedPtr> client_future_goal_handle_;
    std::map<std::string, double> parameters;
    void goal_response_callback(const GoalHandleMst110crReleaseSoil::SharedPtr& goal_handle);
    void feedback_callback(GoalHandleMst110crReleaseSoil::SharedPtr,
