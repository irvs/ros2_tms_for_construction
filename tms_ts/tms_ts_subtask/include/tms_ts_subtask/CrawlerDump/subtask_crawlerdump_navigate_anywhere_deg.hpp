...
#ifndef SAMPLE_SUBTASK_CRAWLERDUMP_NAVIGATE_ANYWHERE_DEG_HPP
#define SAMPLE_SUBTASK_CRAWLERDUMP_NAVIGATE_ANYWHERE_DEG_HPP
...
class SubtaskCrawlerDumpNavigateAnywhereDeg : public SubtaskNodeBase
{
public:
    ...
    SubtaskCrawlerDumpNavigateAnywhereDeg();
