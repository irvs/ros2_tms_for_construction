...
#ifndef SAMPLE_SUBTASK_MST2200_NAVIGATE_THROUGH_POSES_DEG_HPP
#define SAMPLE_SUBTASK_MST2200_NAVIGATE_THROUGH_POSES_DEG_HPP
...
class SubtaskMst2200NavigateThroughPosesDeg : public SubtaskNodeBase
{
public:
    ...
    SubtaskMst2200NavigateThroughPosesDeg();
