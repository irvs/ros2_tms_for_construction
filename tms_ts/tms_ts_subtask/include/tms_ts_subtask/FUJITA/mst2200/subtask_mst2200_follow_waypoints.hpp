...
#ifndef TMS_TS_SUBTASK_MST2200_FOLLOW_WAYPOINTS_HPP
#define TMS_TS_SUBTASK_MST2200_FOLLOW_WAYPOINTS_HPP
...
class SubtaskMst2200FollowWaypointys : public SubtaskNodeBase
{
public:
    ...
    SubtaskMst2200FollowWaypointys();
