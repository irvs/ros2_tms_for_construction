...
class CrawlerdumpFollowWaypoints(EventState):
    '''
    Requests the IC120 crawler dump to follow waypoints via SimpleConnectorHFSMBTH action.

    -- model_name: Model name to control from this node.
    ...
    def __init__(self, model_name, record_name):
        ...
        self._node = rclpy.create_node('crawlerdump_follow_waypoints_client')
