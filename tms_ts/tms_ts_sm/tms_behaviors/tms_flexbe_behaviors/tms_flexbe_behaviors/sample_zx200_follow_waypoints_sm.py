...
"""
Define sample_zx200_follow_waypoints.
...
from tms_flexbe_states.Excavator.excavator_follow_waypoints import ExcavatorFollowWaypoints
...
class sample_zx200_follow_waypointsSM(Behavior):
    """
    Define sample_zx200_follow_waypoints.

    This task is sample implemented on FlexBE. This task contains only one node crresponing to "ExcavatorFollowWaypoints".
    """

    def __init__(self, node):
        super().__init__()
        self.name = 'sample_zx200_follow_waypoints'
        ...
        ExcavatorFollowWaypoints.initialize_ros(node)
