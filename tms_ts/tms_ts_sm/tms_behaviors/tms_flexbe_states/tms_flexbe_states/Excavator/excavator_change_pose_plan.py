...
class ExcavatorChangePosePlan(EventState):
    '''
    Plan trajectory from current pose to the defined pose.
    ...
    def __init__(self, model_name, record_name):
        ...
        self._node = rclpy.create_node('excavator_change_pose_plan_client')
