...
#include <vector>
#include "tms_ts_subtask/Bulldozer/subtask_bulldozer_navigate_through_poses_deg.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

SubtaskBulldozerNavigateThroughPosesDeg::SubtaskBulldozerNavigateThroughPosesDeg() : SubtaskNodeBase("st_bulldozer_navigate_through_poses_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "st_bulldozer_navigate_through_poses_deg",
        std::bind(&SubtaskBulldozerNavigateThroughPosesDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&SubtaskBulldozerNavigateThroughPosesDeg::handle_cancel, this, std::placeholders::_1),
        std::bind(&SubtaskBulldozerNavigateThroughPosesDeg::handle_accepted, this, std::placeholders::_1));

    
    action_client_ = rclcpp_action::create_client<NavigateThroughPoses>(this, "tms_rp_navigate_through_poses_deg");
}

rclcpp_action::GoalResponse SubtaskBulldozerNavigateThroughPosesDeg::handle_goal(
...
rclcpp_action::CancelResponse SubtaskBulldozerNavigateThroughPosesDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskBulldozerNavigateThroughPosesDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&SubtaskBulldozerNavigateThroughPosesDeg::execute, this, _1), goal_handle }.detach();
}

void SubtaskBulldozerNavigateThroughPosesDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void SubtaskBulldozerNavigateThroughPosesDeg::goal_response_callback(const GoalHandleBulldozerNavigateThroughPoses::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void SubtaskBulldozerNavigateThroughPosesDeg::feedback_callback(
...
//result
void SubtaskBulldozerNavigateThroughPosesDeg::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<SubtaskBulldozerNavigateThroughPosesDeg>());
    rclcpp::shutdown();
    return 0;
}
