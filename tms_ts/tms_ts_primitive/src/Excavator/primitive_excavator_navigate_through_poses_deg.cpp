...
#include <vector>
#include "tms_ts_primitive/Excavator/primitive_excavator_navigate_through_poses_deg.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

PrimitiveExcavatorNavigateThroughPosesDeg::PrimitiveExcavatorNavigateThroughPosesDeg() : PrimitiveNodeBase("primitive_excavator_navigate_through_poses_deg_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "primitive_excavator_navigate_through_poses_deg",
        std::bind(&PrimitiveExcavatorNavigateThroughPosesDeg::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&PrimitiveExcavatorNavigateThroughPosesDeg::handle_cancel, this, std::placeholders::_1),
        std::bind(&PrimitiveExcavatorNavigateThroughPosesDeg::handle_accepted, this, std::placeholders::_1));

    
    action_client_ = rclcpp_action::create_client<NavigateThroughPoses>(this, "tms_rp_navigate_through_poses_deg");
}

rclcpp_action::GoalResponse PrimitiveExcavatorNavigateThroughPosesDeg::handle_goal(
...
rclcpp_action::CancelResponse PrimitiveExcavatorNavigateThroughPosesDeg::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void PrimitiveExcavatorNavigateThroughPosesDeg::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&PrimitiveExcavatorNavigateThroughPosesDeg::execute, this, _1), goal_handle }.detach();
}

void PrimitiveExcavatorNavigateThroughPosesDeg::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
    RCLCPP_INFO(this->get_logger(), "primitive(primitive_excavator_navigate_through_poses) is executing...");
...
void PrimitiveExcavatorNavigateThroughPosesDeg::goal_response_callback(const GoalHandleExcavatorNavigateThroughPosesDeg::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void PrimitiveExcavatorNavigateThroughPosesDeg::feedback_callback(
    const GoalHandleExcavatorNavigateThroughPosesDeg::SharedPtr,
    const std::shared_ptr<const GoalHandleExcavatorNavigateThroughPosesDeg::Feedback> feedback)
{
...
//result
void PrimitiveExcavatorNavigateThroughPosesDeg::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
                                             const GoalHandleExcavatorNavigateThroughPosesDeg::WrappedResult& result)
{
  if (!goal_handle->is_active())
  {
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<PrimitiveExcavatorNavigateThroughPosesDeg>());
    rclcpp::shutdown();
    return 0;
}
