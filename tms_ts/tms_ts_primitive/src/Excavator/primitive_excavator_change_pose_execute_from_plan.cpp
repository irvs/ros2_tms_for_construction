...
PrimitiveExcavatorChangePoseExecuteFromJointValues::PrimitiveExcavatorChangePoseExecuteFromJointValues() : PrimitiveNodeBase("primitive_excavator_change_pose_execute_from_joint_values_node")
{
  ...
  action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
      ...
      std::bind(&PrimitiveExcavatorChangePoseExecuteFromJointValues::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
      std::bind(&PrimitiveExcavatorChangePoseExecuteFromJointValues::handle_cancel, this, std::placeholders::_1),
...
rclcpp_action::GoalResponse PrimitiveExcavatorChangePoseExecuteFromJointValues::handle_goal(
...
rclcpp_action::CancelResponse PrimitiveExcavatorChangePoseExecuteFromJointValues::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void PrimitiveExcavatorChangePoseExecuteFromJointValues::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
  using namespace std::placeholders;
  std::thread{ std::bind(&PrimitiveExcavatorChangePoseExecuteFromJointValues::execute, this, _1), goal_handle }.detach();
}

void PrimitiveExcavatorChangePoseExecuteFromJointValues::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
...
int main(int argc, char* argv[])
{
  ...
  rclcpp::spin(std::make_shared<PrimitiveExcavatorChangePoseExecuteFromJointValues>());
  rclcpp::shutdown();
  return 0;
}
