...
#include "tms_ts_primitive/Excavator/primitive_excavator_follow_straight.hpp"
// #include <glog/logging.h>

using std::placeholders::_1;
using std::placeholders::_2;

PrimitiveExcavatorFollowStraight::PrimitiveExcavatorFollowStraight() : PrimitiveNodeBase("primitive_excavator_follow_straight_node")
{
    this->action_server_ = rclcpp_action::create_server<tms_msg_ts::action::LeafNodeBase>(
        this, "primitive_excavator_follow_straight",
        std::bind(&PrimitiveExcavatorFollowStraight::handle_goal, this, std::placeholders::_1, std::placeholders::_2),
        std::bind(&PrimitiveExcavatorFollowStraight::handle_cancel, this, std::placeholders::_1),
        std::bind(&PrimitiveExcavatorFollowStraight::handle_accepted, this, std::placeholders::_1));

    action_client_ = rclcpp_action::create_client<FollowStraight>(this, "tms_rp_navigate_follow_straight");
}

rclcpp_action::GoalResponse PrimitiveExcavatorFollowStraight::handle_goal(
...
rclcpp_action::CancelResponse PrimitiveExcavatorFollowStraight::handle_cancel(const std::shared_ptr<GoalHandle> goal_handle)
{
...
void PrimitiveExcavatorFollowStraight::handle_accepted(const std::shared_ptr<GoalHandle> goal_handle)
{
    using namespace std::placeholders;
    std::thread{ std::bind(&PrimitiveExcavatorFollowStraight::execute, this, _1), goal_handle }.detach();
}

void PrimitiveExcavatorFollowStraight::execute(const std::shared_ptr<GoalHandle> goal_handle)
{
    RCLCPP_INFO(this->get_logger(), "primitive(st_excavator_follow_straight_node) is executing...");
    ...
    auto goal_msg = FollowStraight::Goal();
    ...
    pose.pose.orientation.x = parameters["qx"];
    pose.pose.orientation.y = parameters["qy"];
...
void PrimitiveExcavatorFollowStraight::goal_response_callback(const GoalHandleFollowStraight::SharedPtr& goal_handle)
{
  if (!goal_handle)
  {
...
void PrimitiveExcavatorFollowStraight::feedback_callback(
    const GoalHandleFollowStraight::SharedPtr,
    const std::shared_ptr<const GoalHandleFollowStraight::Feedback> feedback)
{
  RCLCPP_INFO(this->get_logger(), "Received feedback");
  // std::cout << "Feedback: " << feedback->current_waypoint << std::endl;
}

void PrimitiveExcavatorFollowStraight::result_callback(const std::shared_ptr<GoalHandle> goal_handle,
...
int main(int argc, char* argv[])
{
    ...
    rclcpp::spin(std::make_shared<PrimitiveExcavatorFollowStraight>());
    rclcpp::shutdown();
    return 0;
}
