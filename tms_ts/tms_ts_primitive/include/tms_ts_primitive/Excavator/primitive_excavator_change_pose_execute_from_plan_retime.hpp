...
private:
  ...
  rclcpp_action::Client<tms_msg_ts::action::AnalyzeTrajectory>::SharedPtr traj_action_client_;
  rclcpp_action::ClientGoalHandle<tms_msg_ts::action::AnalyzeTrajectory>::SharedPtr traj_goal_handle_;
  ...
  std::shared_future<rclcpp_action::ClientGoalHandle<tms_msg_ts::action::AnalyzeTrajectory>::SharedPtr> traj_future_goal_handle_;
