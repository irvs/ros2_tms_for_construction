...
#ifndef TMS_TS_PRIMITIVE_EXCAVATOR_FOLLOW_WAYPOINTS_DEG_HPP
#define TMS_TS_PRIMITIVE_EXCAVATOR_FOLLOW_WAYPOINTS_DEG_HPP
...
class PrimitiveExcavatorFollowWaypointsDeg : public PrimitiveNodeBase
{
public:
    ...
    PrimitiveExcavatorFollowWaypointsDeg();
