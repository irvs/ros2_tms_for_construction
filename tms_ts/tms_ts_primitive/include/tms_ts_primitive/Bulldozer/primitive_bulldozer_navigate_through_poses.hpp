...
#ifndef SAMPLE_PRIMITIVE_BULLDOZER_NAVIGATE_THROUGH_POSES_HPP
#define SAMPLE_PRIMITIVE_BULLDOZER_NAVIGATE_THROUGH_POSES_HPP
...
class PrimitiveBulldozerNavigateThroughPoses : public PrimitiveNodeBase
{
public:
    ...
    PrimitiveBulldozerNavigateThroughPoses();
...
private:
    ...
    std::shared_future<GoalHandleBulldozerNavigateThroughPoses::SharedPtr> client_future_goal_handle_;
    std::map<std::pair<std::string, std::string>, double> parameters;
    void goal_response_callback(const GoalHandleBulldozerNavigateThroughPoses::SharedPtr& goal_handle);
    void feedback_callback(GoalHandleBulldozerNavigateThroughPoses::SharedPtr,
