...
#ifndef TMS_TS_SUBTASK_BULLDOZER_FOLLOW_WAYPOINTS_HPP
#define TMS_TS_SUBTASK_BULLDOZER_FOLLOW_WAYPOINTS_HPP
...
class SubtaskBulldozerFollowWaypointys : public SubtaskNodeBase
{
public:
    ...
    SubtaskBulldozerFollowWaypointys();
