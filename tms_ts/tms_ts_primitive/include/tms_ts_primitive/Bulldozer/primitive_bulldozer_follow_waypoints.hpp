...
#ifndef TMS_TS_PRIMITIVE_BULLDOZER_FOLLOW_WAYPOINTS_HPP
#define TMS_TS_PRIMITIVE_BULLDOZER_FOLLOW_WAYPOINTS_HPP
...
class PrimitiveBulldozerFollowWaypointys : public PrimitiveNodeBase
{
public:
    ...
    PrimitiveBulldozerFollowWaypointys();
