...
#ifndef SAMPLE_PRIMITIVE_BULLDOZER_NAVIGATE_ANYWHERE_HPP
#define SAMPLE_PRIMITIVE_BULLDOZER_NAVIGATE_ANYWHERE_HPP
...
class PrimitiveBulldozerNavigateAnywhere : public PrimitiveNodeBase
{
public:
    ...
    PrimitiveBulldozerNavigateAnywhere();
...
private:
    ...
    std::shared_future<GoalHandleBulldozerNavigateAnywhere::SharedPtr> client_future_goal_handle_;
    std::map<std::string, double> parameters;
    void goal_response_callback(const GoalHandleBulldozerNavigateAnywhere::SharedPtr& goal_handle);
    void feedback_callback(GoalHandleBulldozerNavigateAnywhere::SharedPtr,
