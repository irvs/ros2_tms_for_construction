...
#ifndef TMS_TS_PRIMITIVE_CRAWLERDUMP_FOLLOW_PATH_HPP
#define TMS_TS_PRIMITIVE_CRAWLERDUMP_FOLLOW_PATH_HPP
...
class PrimitiveCrawlerDumpFollowPath : public PrimitiveNodeBase
{
public:
    ...
    PrimitiveCrawlerDumpFollowPath();
...
private:
    ...
    std::shared_future<GoalHandleFollowPath::SharedPtr> client_future_goal_handle_;
...
#endif  // TMS_TS_PRIMITIVE_CRAWLERDUMP_FOLLOW_WAYPOINTS_HPP
