...
from sensing_msgs.msg import NavigateAnywhere
...
class UpdateDB_Parameter(Node):
    def __init__(self):
        super().__init__("tms_sp_navigate_anywhere")
        self.subscription = self.create_subscription(
            NavigateAnywhere,
            '/tms_sp_navigate_anywhere',
            self.update_db_parameter,
            10) 
    
    def update_db_parameter(self, msg: NavigateAnywhere) -> None:
