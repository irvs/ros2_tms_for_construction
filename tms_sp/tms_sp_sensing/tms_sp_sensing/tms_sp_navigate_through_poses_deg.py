...
from sensing_msgs.msg import NavigateThroughPosesDeg
...
class UpdateDB_Parameter(Node):
    def __init__(self):
        super().__init__("tms_sp_navigate_through_poses_deg")
        self.subscription = self.create_subscription(
            NavigateThroughPosesDeg,
            '/tms_sp_navigate_through_poses_deg',
            self.update_db_parameter,
            10) 
    
    def update_db_parameter(self, msg: NavigateThroughPosesDeg) -> None:
