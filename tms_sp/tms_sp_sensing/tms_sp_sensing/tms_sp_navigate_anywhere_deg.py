...
from sensing_msgs.msg import NavigateAnywhereDeg
...
class UpdateDB_Parameter(Node):
    def __init__(self):
        super().__init__("tms_sp_navigate_anywhere_deg")
        self.subscription = self.create_subscription(
            NavigateAnywhereDeg,
            '/tms_sp_navigate_anywhere_deg',
            self.update_db_parameter,
            10) 
    
    def update_db_parameter(self, msg: NavigateAnywhereDeg) -> None:
