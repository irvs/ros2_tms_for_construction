...
from sensing_msgs.msg import NavigateThroughPoses
...
class UpdateDB_Parameter(Node):
    def __init__(self):
        super().__init__("tms_sp_navigate_through_poses")
        self.subscription = self.create_subscription(
            NavigateThroughPoses,
            '/tms_sp_navigate_through_poses',
            self.update_db_parameter,
            10) 
    
    def update_db_parameter(self, msg: NavigateThroughPoses) -> None:
