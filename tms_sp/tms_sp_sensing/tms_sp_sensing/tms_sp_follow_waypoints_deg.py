...
from sensing_msgs.msg import FollowWaypointsDeg
...
class UpdateDB_Parameter(Node):
    def __init__(self):
        super().__init__("tms_sp_follow_waypoints_deg")
        self.subscription = self.create_subscription(
            FollowWaypointsDeg,
            '/tms_sp_follow_waypoints_deg',
            self.update_db_parameter,
            10) 
    
    def update_db_parameter(self, msg: FollowWaypointsDeg) -> None:
