...
from sensing_msgs.msg import ExcavateSimple
...
class UpdateDB_Parameter(Node):
    def __init__(self):
        super().__init__("tms_sp_excavate_simple")
        self.subscription = self.create_subscription(
            ExcavateSimple,
            '/tms_sp_excavate_simple',
            self.update_db_parameter,
            10) 
    
    def update_db_parameter(self, msg: ExcavateSimple) -> None:
