...
from sensing_msgs.msg import ReleaseLocations
...
class UpdateDB_Parameter(Node):
    def __init__(self):
        super().__init__("tms_sp_release_locations")
        self.subscription = self.create_subscription(
            ReleaseLocations,
            '/tms_sp_release_locations',
            self.update_db_parameter,
            10) 
    
    def update_db_parameter(self, msg: ReleaseLocations) -> None:
