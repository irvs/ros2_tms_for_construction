...
def generate_launch_description():
    # Arguments
    filename = DeclareLaunchArgument("filename", default_value="filename.pcd")
    ...
    voxel_size = DeclareLaunchArgument("voxel_size", default_value="0.0")
    octree_depth = DeclareLaunchArgument("octree_depth", default_value="2")
    density_th = DeclareLaunchArgument("density_th", default_value="0.1")
    fill_nan_type = DeclareLaunchArgument("fill_nan_type", default_value="none")
