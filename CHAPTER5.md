### 5. How to Use the Global Blackboard
...
タスクの実装が完了したらCHAPTER3の手順にしたがってMonogDB上にタスクデータを格納してください。 -->
