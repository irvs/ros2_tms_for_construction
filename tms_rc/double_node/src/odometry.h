...
#ifndef GUIDEBOT_ODOMETRY_H
#define GUIDEBOT_ODOMETRY_H
...
class Odometry
{
 public:
  ...
  nav_msgs::msg::Odometry getOdom(const rclcpp::Time now, const double wheel_radius, const geometry_msgs::msg::Vector3::SharedPtr input_odom);
